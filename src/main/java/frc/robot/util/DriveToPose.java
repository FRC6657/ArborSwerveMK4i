...
public class DriveToPose extends Command {
  ...
  public void execute() {
    ...
    driveVelocity =
        driveVelocity.interpolate(linearFF.get().times(SwerveConstants.maxLinearSpeed), linearS);
    thetaVelocity =
        MathUtil.interpolate(
            thetaVelocity, omegaFF.getAsDouble() * SwerveConstants.maxAngularSpeed, thetaS);
